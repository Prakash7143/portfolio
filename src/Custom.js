    ...
    return (
        <>
            <div className="template-index home2-default">
                ...
                {/*  */}
                {/* <!--Promotion Bar--> */}
	<div id="mobilehide" className="notification-bar mobilehide">
    	<a href="#" className="notification-bar__message">20% off your very first purchase, use promo code: belle fashion</a>
        <span onClick={() => { getClose() }} className="close-announcement">×</span>
    </div>
    {/* <!--End Promotion Bar--> */}
	{/* <!--Search Form Drawer--> */}
	<div className="search">
        <div className="search__form">
            <form className="search-bar__form" action="#">
                ...
                <input className="search__input" type="search" name="q"  placeholder="Search entire store..." aria-label="Search" autocomplete="off"/>
            </form>
        ...
        <div className="container-fluid">
            <div className="row">
            	<div className="col-10 col-sm-8 col-md-5 col-lg-4">
                    <div id="currency-picker" onClick={() => { getSelectCurrency() }} className="currency-picker">
    	...
    	<div className="container-fluid">        
            <div className="row align-items-center">
                ...
                <div className="logo col-md-2 col-lg-2 d-none d-lg-block">
                    <a href="index.html">
                    	<img src={process.env.PUBLIC_URL + 'assets/images/logo.svg'} alt="Belle Multipurpose Html Template" title="Belle Multipurpose Html Template" />
                    </a>
                </div>
                {/* <!--End Desktop Logo--> */}
                                            ...
                                            <ul className="grid">
                                                <li className="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" className="site-nav lvl-1">Home Group 1</a>
                                                    <ul className="subLinks">
                                                      <li className="lvl-2"><a href="index.html" className="site-nav lvl-2">Home 1 - Classic</a></li>
                            	...
                            	<div className="megamenu style4">
                                    <ul className="grid grid--uniform mmWrapper">
                                    	<li className="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" className="site-nav lvl-1">Shop Pages</a>
                                      	...
                                      	<li className="grid__item lvl-1 col-md-3 col-lg-3"><a href="#" className="site-nav lvl-1">Shop Features</a>
                                            <ul className="subLinks">
                                                ...
                                                <li className="lvl-2"><a href="shop-grid-3.html" className="site-nav lvl-2">Pagination - Classic</a></li>
                                        ...
                                        <li className="grid__item lvl-1 col-md-6 col-lg-6">
                                        	<a href="#"><img src={process.env.PUBLIC_URL + "assets/images/megamenu-bg1.jpg"} alt="" title="" /></a>
                                        </li>
                                    </ul>
                              	</div>
                            </li>
                        	...
                        	<div className="megamenu style2">
                                <ul className="grid mmWrapper">
                                    <li className="grid__item one-whole">
                                  	...
                                  	<li className="grid__item large-up--one-whole imageCol"><a href="#"><img src={process.env.PUBLIC_URL + "assets/images/megamenu-bg2.jpg"} alt=""/></a></li>
                                </ul>
                          	</div>
                        </li>
                        	...
                        	<ul className="mini-products-list">
                                <li className="item">
                                	<a className="product-image" href="#">
                                    	<img src={process.env.PUBLIC_URL + "assets/images/product-images/cape-dress-1.jpg"} alt="3/4 Sleeve Kimono Dress" title="" />
                                    </a>
                                ...
                                <li className="item">
                                	<a className="product-image" href="#">
                                    	<img src={process.env.PUBLIC_URL + "assets/images/product-images/cape-dress-2.jpg"} alt="Elastic Waist Dress - Black / Small" title="" />
                                    </a>
                                    <div className="product-details">
                                    	<a href="#" className="remove"><i className="anm anm-times-l" aria-hidden="true"></i></a>
                                        <a href="#" className="edit-i remove"><i className="anm anm-edit" aria-hidden="true"></i></a>
        ...
        <ul id="MobileNav" className="mobile-nav">
          ...
          <ul>
            <li><a href="#" className="site-nav">Home Group 1<i className="anm anm-plus-l"></i></a>
              <ul>
                <li><a href="index.html" className="site-nav">Home 1 - Classic</a></li>
